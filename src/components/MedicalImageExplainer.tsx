          ...
          >
            ...
            <div className="p-8 border-b flex items-center justify-between bg-white/50 backdrop-blur-md sticky top-0 z-20">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 bg-gradient-to-br from-brand to-brand-dark rounded-2xl flex items-center justify-center text-white shadow-xl shadow-brand/20">
                  <Stethoscope size={28} />
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-[11px] text-slate-500 font-black uppercase tracking-widest">{t.scanAnalysis} • {language}</p>
                  </div>
                </div>
              </div>
              <button 
